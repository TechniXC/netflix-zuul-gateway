package ru.jug.netflixZuulGateway.configuration;
...
public class ClientVersionsConfiguration {
    ...
    private Map<String, Map<String, Integer>> versions;

    public Integer getServiceVersion(String mobileVersion, String serviceName) {
